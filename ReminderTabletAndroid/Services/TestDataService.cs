...
namespace ReminderTabletAndroid.Services
{
    public static class TestDataService
    {
        ...
        public static List<ReminderTabletAndroid.Models.Contact> GetDefaultContacts()
        {
            return new List<ReminderTabletAndroid.Models.Contact>
            {
                new ReminderTabletAndroid.Models.Contact { Name = "Tarja (tytär)", Phone = "+358401234567" },
                new ReminderTabletAndroid.Models.Contact { Name = "Päivi (sisar)", Phone = "+358501234567" },
                new ReminderTabletAndroid.Models.Contact { Name = "Eino (veli)", Phone = "+358451234567" }
            };
        }
